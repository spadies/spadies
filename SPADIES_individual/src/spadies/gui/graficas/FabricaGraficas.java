...
public final class FabricaGraficas {
  ...
  public static ChartPanel crearGraficaConteosPoblacion(String titulo, SVariable[] diferenciados, Object[] args, boolean porcentual){
	    return crearGraficaConteosPoblacion(titulo,diferenciados,args,porcentual,null); 
	  }
  ...
  public static ChartPanel crearGraficaConteosPoblacion(String titulo, SVariable[] diferenciados, Object[] args, boolean porcentual, FiltroDouble fd) {
	    return crearGraficaConteosPoblacion(titulo, diferenciados, args, porcentual, false, 0, fd );
	  }
  ...
  public static ChartPanel crearGraficaConteosPoblacion(String titulo, SVariable[] diferenciados, Object[] args, boolean porcentual, boolean periodos, int offsetX){
	   return crearGraficaConteosPoblacion(titulo,diferenciados,args,porcentual,periodos,offsetX,null);  
  }
  ...
  public static ChartPanel crearGraficaConteosPoblacion(String titulo, SVariable[] diferenciados, Object[] args, boolean porcentual, boolean periodos, int offsetX,FiltroDouble fd) {
    return crearGraficaConteosPoblacion(titulo,periodos?"Período":"# de semestres cursados",porcentual?"% desertores":"Conteo de matriculados",diferenciados,args,porcentual,periodos,offsetX,fd); 
  }
  public static ChartPanel crearGraficaConteosPoblacion(String titulo, String ejex, String ejey, SVariable[] diferenciados, Object[] args, boolean porcentual, boolean periodos, int offsetX,FiltroDouble fd) {
	    Map<byte[],? extends Object> datos=(Map<byte[],? extends Object>)(args[0]);
	    Integer[] codigosIESDif=(Integer[])(args[1]);
	    String[] codigosProgramasDif=(String[])(args[2]);
	    XYPlot plot=new XYPlot();
	    ...
	    for (Map.Entry<byte[],? extends Object> e:datos.entrySet()) {
	      ...
	      StringBuffer nombreSerie=new StringBuffer();
	      for (int i=0,t=diferenciados.length; i<t; i++) {
	        nombreSerie.append((i>0?",":"")+SVariable.toString(diferenciados[i],llave[i]));
	      }
	      XYSeries dataSeries=new XYSeries(nombreSerie.toString());
	      if (!porcentual) {
	        int cont[]=(int[])(e.getValue());
