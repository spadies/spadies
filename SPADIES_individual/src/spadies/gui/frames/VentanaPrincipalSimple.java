...
public final class VentanaPrincipalSimple extends JFrame implements Observer {
  ...
  private VentanaPrincipalSimple() {
    ...
    JPanel botonera = new JPanel(new GridLayout(0, botonesH));
    {
      ...
      //botonera.add(new JButton("Consultas básicas"));
      //botonera.add(new BotonProcesador("Deserción por cohorte",ProcesadorDesercionCohorte.instance));
      botonera.add(new BotonProcesador("Deserción por cohorte",ProcesadorConsultaDesercion.instance));
      botonera.add(new BotonProcesador("Deserción por período",ProcesadorDesercionPorPeriodo.instance));
      botonera.add(new BotonProcesador("Caracterización de los estudiantes",ProcesadorCaracterizacionEstudiantes.instance));
      ...
      botonera.add(new BotonProcesador("Análisis de supervivencia",ProcesadorAnalisisSupervivencia.instance));
      //botonera.add(new JButton("Información por individuo"));
      botonera.add(new BotonProcesador("Costos monetarios de la deserción",ProcesadorCostoDesercion.instance));
    ...
    }
    {
      ...
      /*
      panelCentro.addTab("Tasa deserción 2",panelDesercionCT);
      
      panelCentro.addTab("Deserción",panelDesercion);
    ...
    MySplitPane splitPrincipal=new MySplitPane(JSplitPane.HORIZONTAL_SPLIT,false,
        ...
        new MyBoxPane(BoxLayout.Y_AXIS,
            new MyFlowPane(0,0,Box.createVerticalStrut(3),
                new MyLabel("<html><i><b><font color=\"#000070\">Selección del tipo de análisis</font></b></i></html>")),
                comboSeleccion,
  ...
  private final class MyMenuBar extends JMenuBar {
    public MyMenuBar() {
      ...
      botonSc.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          if (!RutinasGUI.desplegarPregunta(VentanaPrincipalSimple.this,"<html>¿Desea sincronizar el sistema con los datos en la carpeta "+CajaDeHerramientas.stringToCSV(Constantes.carpetaCSV.getPath())+" y con el Ministerio de Educación Nacional? La operación puede tardar varios minutos.</html>")) return;
  ...
  private class BotonProcesador extends JButton implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      new MyDialogProgreso(VentanaPrincipalSimple.getInstance(),"Realizando la consulta"+(alMen?" en el Ministerio de Educación Nacional":""),false) {
