...
public class PanelConsultasDesercionIntersemestral extends JPanel implements ActionListener {
  ...
  private class VentanaRealizarConsultaGrafica extends MyDialogProgreso {
    ...
    private void generarGrafica() throws Exception {
      ...
      ChartPanel graf=FabricaGraficas.crearGraficaConteosPoblacion("","Período","Número de ausentes",diferenciados,new Object[]{resC,codigosIESDif,codigosProgramasDif},false,true, 0xFF&limInf);
      ChartPanel grafPorc=FabricaGraficas.crearGraficaConteosPoblacion("","Período","% ausencia",diferenciados,new Object[]{resP,codigosIESDif,codigosProgramasDif},true,true, 0xFF&limInf);
