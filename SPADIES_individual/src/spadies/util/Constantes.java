...
public final class Constantes {
  ...
  public static final String versionMenor = "2.8.1";
  public static final String nombreAplicacion="SPADIES IND 2.8";
  public static final String nombreAplicacionLargo="SPADIES IND "+versionMenor;
  ...
  public static final boolean cargaDatosPersonales = true;
  ...
  public static Collection<String> filtroIES = Collections.EMPTY_SET;
  ...
  public static void cargarArchivoFiltroIES() {
    filtroIES = Collections.EMPTY_SET;
