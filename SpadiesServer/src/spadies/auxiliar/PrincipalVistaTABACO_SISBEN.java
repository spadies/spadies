...
public class PrincipalVistaTABACO_SISBEN {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final File fTabaco = new File("taba_red.csv");
    final File fSalida = new File("taba_sisben.csv");
    {//Match SISBEN-Encuesta
      int regs = registrosEnArchivo(fTabaco);
      System.out.println("Registros tabaco: " + regs);
      byte[][][] INFO_IES = new byte[3][regs][];//Lazye :P
      {
        BufferedReader br = new BufferedReader(new FileReader(fTabaco));
        br.readLine();//Encabezado
        int i = 0;
        for (String s = br.readLine();s!=null;s = br.readLine()) {
          String sL[] = csvToString(s,0,';');
          INFO_IES[0][i]=codifLetrasServer.getCodigos(sL[0]);
          INFO_IES[1][i]=codifNumeros.getCodigos(sL[1]);
      ...
      int encontrados = 0;
      {
        ...
        System.out.println("Individuos TABACO encontrados SISBEN: " + encontrados);
        {
