...
public class PanelConsultasCostoDesercion extends JPanel implements ActionListener {
  ...
  public PanelConsultasCostoDesercion() {
    for (int i=0; i<tam; i++) {
  ...
  private class VentanaRealizarConsultaGrafica extends MyDialogProgreso {
    ...
    private void generarGrafica() throws Exception {
      ...
      VentanaTablas vt = new VentanaTablas(VentanaPrincipal.getInstance(),"Resultado consulta",new MyEditorPane(false,getStringSeleccion()),
          new String[]{"Ausentes intersemestrales","Costo deserción"},
          new InfoTabla[]{tabla,tablaPorc},100);
      vt.setVisible(true);
    }
  }
