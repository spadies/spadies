...
public class CargadorEstudiantes {
  ...
  public Estudiante cargar(MyDataInputStream is) throws Exception {
    ...
    switch (version) {
      ...
      case V_P_1_0:return new Estudiante_POS_1_0(n,new MyByteSequence(ba));
      default:return null;
    }    
  }
  public Estudiante estudianteVacio() {
    switch (version) {
      ...
      case V_P_1_0:return new Estudiante_POS_1_0(n,new MyByteSequence(tam));
      default:return null;
    }    
  }
