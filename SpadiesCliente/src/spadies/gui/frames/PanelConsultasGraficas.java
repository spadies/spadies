...
public class PanelConsultasGraficas extends JPanel implements ActionListener {
  ...
  public void actualizarLabelSeleccion() {
  ...
  private class VentanaRealizarConsultaGrafica extends MyDialogProgreso {
    ...
    private void generarGrafica() throws Exception {
      ...
      ChartPanel graf=FabricaGraficas.crearGraficaConteosPoblacion("","# de semestres cursados","Número de sobrevivientes",diferenciados,new Object[]{resC,codigosIESDif,codigosProgramasDif},false,false,0,null);
      ChartPanel grafPorc=FabricaGraficas.crearGraficaConteosPoblacion("","# de semestres cursados","% supervivencia",diferenciados,new Object[]{resP,codigosIESDif,codigosProgramasDif},true,false,0,null);
