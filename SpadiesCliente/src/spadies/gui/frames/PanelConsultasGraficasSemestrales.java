...
public class PanelConsultasGraficasSemestrales extends JPanel implements ActionListener {
  ...
  public PanelConsultasGraficasSemestrales() {
    for (int i=0; i<tam; i++) {
  ...
  private String getStringSeleccion() {
    ...
    return RutinasGUI.getStringSeleccion("<i>Tenga en cuenta que</i> en el sistema sólo se consideran estudiantes que ingresaron a las IES en los períodos que cada institución suministró datos.<p><p>",(MyPanelSeleccion[])(params[0]),(JCheckBox[])(params[1]),(Variable[])(params[2]),null,VentanaPrincipal.getInstance().estaSeleccionandoAgregado());
  }
  public void actionPerformed(ActionEvent e) {
    ...
    if (ind==0) {
      ...
      try {
        ...
        new VentanaRealizarConsultaGraficaSemestral(ag,diferenciados,filtros).ejecutar();
      }
  ...
  private class VentanaRealizarConsultaGraficaSemestral extends MyDialogProgreso {
    private final boolean alMinisterio;
    private final Variable[] diferenciados;
    private final Filtro[] filtros;
    public VentanaRealizarConsultaGraficaSemestral(boolean pAlMinisterio, Variable[] pDiferenciados, Filtro[] pFiltros) {
    ...
    public void ejecutar() {
      ...
      new Thread() {
        public void run() {
          Window window=VentanaRealizarConsultaGraficaSemestral.this;
          try {
            generarGrafica();
          }
          catch (MyException ex) {
    ...
    private void generarGrafica() throws Exception {
      ...
      ChartPanel graf=FabricaGraficas.crearGraficaConteosPoblacionSemestral("",diferenciados,new Object[]{resC,codigosIESDif,codigosProgramasDif,limsSems},false);
      ChartPanel grafPorc=FabricaGraficas.crearGraficaConteosPoblacionSemestral("",diferenciados,new Object[]{resP,codigosIESDif,codigosProgramasDif,limsSems},true);
      ...
      VentanaRealizarConsultaGraficaSemestral.this.dispose();
